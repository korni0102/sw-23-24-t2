...
<div class="position-absolute top-50 start-50 translate-middle">
    <div class="card" style="width: 100%;">
        <img src="{{ asset('images/logo.jpg') }}" style="height: 250px; width: auto; padding: 5px"
             class="card-img-top mx-auto my-auto" alt="Logo">
        <div class="card-body">
            <h3 class="card-title">Registrácia</h3>
            <form action="{{ route('save.user') }}" method="post">
                ...
                @enderror
                <br>
                <h5 class="card-title">Školský rok</h5>
                ...
                <div class="input-group mb-3">
                    <input type="password" placeholder="Min 8" id="password" name="password" class="form-control"
                           required aria-describedby="show-password">
                    <button class="btn btn-outline-dark" type="button" id="show-password"><i class="bi bi-eye"></i>
                    </button>
                </div>
                @error('password')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <br>
                <h5 class="card-title">Rola</h5>
                <div class="form-group">
                    <li class="list-group-item">
                        <select style="border-radius: 0px" class="form-select form-select-lg mb-3" id="role_id"
                                name="role_id" required>
                            <option value="" disabled selected hidden>Vyberte si rolu</option>
                ...
                <div class="form-group" id="study_program_choose" style="display: none !important;">
                    <li class="list-group-item">
                        <select style="border-radius: 0px" class="form-select form-select-lg mb-3" id="study_program_id"
                            ...
                            <option value="6">Matematicko-štatistické a informačné metódy v ekonómii a finančníctve
                            </option>
