...
<div class="position-absolute top-50 start-50 translate-middle">
    <div class="card" style="width: 20rem;">
        ...
        <div class="card-body">
            <h3 class="card-title">Prihlásenie</h3>
            <form action="{{ route('login.login') }}" method="post">
                ...
                @endif
                <h5 class="card-title">Zadajte e-mail</h5>
                <input type="text" id="email" name="email" class="form-control" placeholder="E-mail"
                       aria-label="Username" aria-describedby="addon-wrapping" required
                       oninvalid="this.setCustomValidity('Prosím, zadaj e-mail!')" oninput="this.setCustomValidity('')">
                <br>
                <h5 class="card-title">Zadajte heslo</h5>
                <input type="password" id="password" name="password" class="form-control" placeholder="Heslo"
                       aria-label="Username" aria-describedby="addon-wrapping" required
                       oninvalid="this.setCustomValidity('Prosím, zadaj heslo!')" oninput="this.setCustomValidity('')">
                <br>
                <button type="submit" class="btn btn-warning">Prihlásenie</button>
            </form>
            <br>
